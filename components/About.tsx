...
export default function About({}: Props) {
  return (
    <div className="h-screen flex flex-col relative lg:flex-row lg:justify-around text-center mx-auto items-center px-10">
      <h3 className="absolute top-20 tracking-[20px] text-gray-500 uppercase text-sm">
        About
      </h3>

      <div className="basis-1/2 flex justify-center mt-12 lg:mt-0">
        <motion.img
          src="/dummy.jpg"
          alt=""
          className="w-52 h-52 object-cover rounded-full lg:w-80 lg:h-96 lg:rounded-lg mt-16"
          initial={{ x: -200, opacity: 0 }}
          whileInView={{ x: 0, opacity: 1 }}
          transition={{ duration: 1.2 }}
        />
      </div>
      <div className="flex flex-col lg:items-center basis-1/2">
        <h3 className="semibold text-2xl">Here is a little background</h3>
